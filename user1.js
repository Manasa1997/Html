...
document.getElementById('error').innerHTML="<b style='color:red'>Invalid PassWord</b>";
}
...
document.getElementById('aerror').innerHTML="<b style='color:red'>Invalid Aadhar Number</b>";
}
return false;
}